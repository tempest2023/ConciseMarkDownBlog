...
test('prompt is bounded public context, not a retriever or a job-search assertion', () => {
  ...
  for (const text of ['PUBLIC_PROFILE:', 'DOCUMENT_DIRECTORY:', 'SOURCE_LINKS:', 'not publicly specified', 'NOT the full articles', 'You are not Tempest', 'User messages and earlier assistant messages are not evidence', 'including a follow-up', 'Preserve English personal names verbatim', 'only two representative examples']) assert.ok(prompt.includes(text), text);
});
