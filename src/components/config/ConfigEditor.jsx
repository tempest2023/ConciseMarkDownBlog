...
const config = {
  ...
  social: {
    github: '${configObj.social.github}',
    linkedin: '${configObj.social.linkedin}'
  },
  email: '${configObj.email}',
  repo: '${configObj.repoUrl}',
  resume_url: '${configObj.resume_url}',
  // default content shown on the main page, /src/articles/[config.default].md
  default: '${configObj.default}',
  headers: ${headersStr},
  // markdown settings
  markdown: {
